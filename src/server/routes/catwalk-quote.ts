 ...
 */
export async function postCatwalkQuote(request: Request, runtimeEnv: Record<string, unknown> = {}) {
...
export const rejectCatwalkQuoteMethod = (_context?: unknown) => methodNotAllowed()
