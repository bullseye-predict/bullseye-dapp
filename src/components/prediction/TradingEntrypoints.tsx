...
const loading = <AppShell className="solz-home cc-loading-shell" active="highlight"><p className="cc-loading-state" role="status"><i aria-hidden="true"/>Loading arena…</p></AppShell>
